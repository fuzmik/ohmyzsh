# Generated by Powerlevel10k configuration wizard on 2024-11-24 at 16:13 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_SWAP_BACKGROUND=4
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(.*tun)|tailscale|CloudflareWARP)[0-9]*|(zt.*)'
